...
video_capture = cv2.VideoCapture('http://admin:admin@192.168.0.31:8554/live')
...
out = cv2.VideoWriter("./cars_deepgaze.avi", fourcc, 20.0, (res_h,res_v))
...
print(res_h,"x",res_v,",",count_frames_all,",",count_frames_motion)
